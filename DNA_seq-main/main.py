...
def main():
    ...
    if choice == "Intro":
        ...
        if file_similarity is not None:
            human_data = pd.read_table('C:\\Users\\Steven20367691\\Downloads\\DNA-Sequencing-Classifier-master\\human_data.txt')
            chimp_data = pd.read_table('C:\\Users\\Steven20367691\\Downloads\\DNA-Sequencing-Classifier-master\\chimp_data.txt')
            dog_data = pd.read_table('C:\\Users\\Steven20367691\\Downloads\\DNA-Sequencing-Classifier-master\\dog_data.txt')
